...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    {
        Chameleon.setGlobalThemeUsingPrimaryColor(UIColor.flatOrangeColor(), withSecondaryColor: UIColor.flatWhiteColor(), usingFontName: "AppleSDGothicNeo-SemiBold", andContentStyle: UIContentStyle.Contrast)
